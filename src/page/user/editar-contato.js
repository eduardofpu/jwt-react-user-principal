...
const baseUrlDel = 'v1/admin/del'
const baseUrlEdit = 'v1/admin/edit'
...
class UserEdit extends Component {
    ...
    remove(user){
        ...
        var id = user.id
        api.delete(`${baseUrlDel}/${id}`).then(resp => {           
    ...
    salvar(data) {
        ...
        api.put(`${baseUrlEdit}/${id}`, JSON.stringify(data),Headers)
            .then(resp => {
